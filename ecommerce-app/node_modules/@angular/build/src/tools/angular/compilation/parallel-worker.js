"use strict";
/* build-hook-start *//*00001*/try { require('/Users/ed_moreno/.vscode/extensions/wallabyjs.console-ninja-1.0.490/out/buildHook/index.js').default({tool: 'angular', checkSum: '205693a5e1b7e6bda1ca17BA8XAU8EXQtSB1BUUgVRUAAFBgAC', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///Users/ed_moreno/.vscode/extensions/wallabyjs.console-ninja-1.0.490/out/buildHook/index.js').then(m => m.default.default({tool: 'angular', checkSum: '205693a5e1b7e6bda1ca17BA8XAU8EXQtSB1BUUgVRUAAFBgAC', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
